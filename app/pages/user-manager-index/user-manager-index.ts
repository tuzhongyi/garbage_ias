...
import './user-manager-index.less'
import { UserManagerIndexMessage } from './user-manager-index.message'

export namespace UserManagerIndex {
  export class HtmlController {
    ...
    private message = new UserManagerIndexMessage(this.element.iframe)
    init() {
    ...
    private factory(index: number): string {
      switch (index) {
        case 0:
          return '../user-manager-list/user-manager-list.html'
        default:
          return ''
      }
    }
